...
If your file manager is not letting you access the /Android/data/ directory, try uninstalling updates of the system Files app or using [MT Manager](https://apkcombo.com/mt-manager/bin.mt.plus).
