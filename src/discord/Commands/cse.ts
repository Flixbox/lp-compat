...
module.exports = {
  ...
  execute: async (interaction) => {
    return await interaction.followUp(
      `
To check for an app that is incompatible with Lucky Patcher, you can visit the modded APK CSE in [r/freemediaheckyeah](https://www.reddit.com/r/freemediaheckyeah/). 
You can find the APK files that have been manually modified under: Wiki (pinned post) > Android / iOS > Android APKs. 
