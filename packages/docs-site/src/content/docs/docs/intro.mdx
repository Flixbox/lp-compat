...
import LP_App_patching_step_1 from "../../../assets/img/create_modified_apk.jpg";
import LP_App_patching_step_2 from "../../../assets/img/rebuild_categories_selection.jpg";
import LP_App_patching_step_3 from "../../../assets/img/ad_patches.jpg";
import LP_App_patching_step_4 from "../../../assets/img/iap_patches.jpg";
import LP_App_patching_step_5 from "../../../assets/img/LP_App_patching_step_5.jpg";
import LP_App_patching_step_6 from "../../../assets/img/LP_App_patching_step_6.jpg";
import LP_App_battery_saver from "../../../assets/img/battery.png";
...
Read the [important info about LP](/docs/lp-info) section.
...
<img src={LP_App_battery_saver.src} style={{ height: "700px" }} />
...
<img src={LP_App_patching_step_1.src} style={{ height: "700px" }} />

<Box m={2} display="inline" />

<img src={LP_App_patching_step_2.src} style={{ height: "700px" }} />

4. You can leave those checkboxes as-is, but applying these patches would be good.

<img src={LP_App_patching_step_3.src} style={{ height: "700px" }} />

<Box m={2} display="inline" />

<img src={LP_App_patching_step_4.src} style={{ height: "700px" }} />
...
<img src={LP_App_patching_step_5.src} style={{ height: "700px" }} />

<Box m={2} display="inline" />

<img src={LP_App_patching_step_6.src} style={{ height: "700px" }} />
